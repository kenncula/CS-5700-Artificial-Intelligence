...
import grading
import importlib # used to be `import imp`
import optparse
import os
import re
import sys
...
def loadModuleString(moduleSource):
    ...
    #tmp = imp.new_module(k) # imp was deprecated in python 3.4
    tmp = importlib.import_module(k)
...
def loadModuleFile(moduleName, filePath):
    with open(filePath, 'r') as f:
        #return imp.load_module(moduleName, f, "%s.py" % moduleName, (".py", "r", imp.PY_SOURCE)) # imp was deprecated in python 3.4
